...
const NuevoPassword = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (password.length < 6) {
            setAlerta({
                msg: 'El Password debe ser mínimo a de 6 carácteres',
                error: true
            })
            return
        }
    ...
    return (
        <>
        <div>
            <h1 className="text-indigo-600 font-black text-5xl">Reestablece tu{' '}<span className="text-black">Password</span></h1>
        </div>
